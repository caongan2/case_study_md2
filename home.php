...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="home.php">
            ...
            <div class="sidebar-brand-text mx-3">Box Fetch <sup>CF</sup></div>
        </a>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="index.php?page=product&product=home" data-toggle="collapse" data-target="#collapseUtilities"
        ...
        <!-- Nav Item - Pages Collapse Menu -->
        <li class="nav-item">
            <a class="nav-link collapsed" href="index.php?page=home" data-toggle="collapse" data-target="#collapsePages"
            ...
            <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="index.php?page=register">Register New User</a>
                    <a class="collapse-item" href="#">Update Password</a>
        ...
        <!-- Nav Item - Charts -->
<!--        <li class="nav-item">-->
<!--            <a class="nav-link" href="index.php?page=product&product=home">-->
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow d-sm-none">
                        <a class="nav-link dropdown-toggle" href="index.php?page=product&product=home" id="searchDropdown" role="button"
                    ...
                    <li class="nav-item dropdown no-arrow mx-1">
                        <a class="nav-link dropdown-toggle" href="index.php?page=product&product=home" id="alertsDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="index.php?page=product&product=home">
                                <div class="mr-3">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <form class="collapse-item " action="" method="post">
                                ...
                                <input type="submit" name="logOut" value="Logout" class="btn btn-block">
